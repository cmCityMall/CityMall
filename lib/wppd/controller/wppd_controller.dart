...
class WPPDController extends GetxController {
  ...
  void onInit() {
    discountPrice.value =
        dataController.selectedWeekPromotion.value!.isPercentage
            ? ((dataController.selectedProduct.value!.price / 100) *
                    dataController.selectedWeekPromotion.value!.percentage!)
                .round()
            : dataController.selectedWeekPromotion.value!.descountPrice!;
