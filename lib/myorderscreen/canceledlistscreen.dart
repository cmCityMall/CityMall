...
class CanceledListScreen extends StatelessWidget {
  CanceledListScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Obx(() {
        ...
        if (orderController.cancelList.isEmpty) {
          return const EmptyWidget("No canceled orders yet.");
        }
        return ListView.builder(
          itemCount: orderController.cancelList.length,
          shrinkWrap: true,
          itemBuilder: (BuildContext context, int index) {
            final purchase = orderController.cancelList[index];
