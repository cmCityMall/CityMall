...
class PPVAView extends StatelessWidget {
  PPVAView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final PPVAController ppvaController = Get.find();
          ...
          child: Column(
            children: [
                ...
                child: Padding(
                  ...
                  child: Obx(() {
                    ...
                    if (dataList == null || dataList.isEmpty) {
                      return const EmptyWidget("No Popular Products yet.");
                    }
              ...
              Align(
                ...
                child: Obx(() => ppvaController.isLoading.value
                    ? AnimatedContainer(
