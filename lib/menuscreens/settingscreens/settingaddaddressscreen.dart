...
class SettingAddAddressScreen extends StatelessWidget {
  SettingAddAddressScreen({Key? key}) : super(key: key);
  final ThemeController themeController = Get.put(ThemeController());
  final SettingAddressClickController ontapAddressController =
      Get.put(SettingAddressClickController());
